          ...
          <table className="w-full">
            ...
            <tfoot>
              <tr className="border-t-2 font-bold">
                ...
                <td className="text-right py-3 px-4">
                  {data
                    .reduce((sum, emp) => sum + emp.regularHours, 0)
                    .toFixed(1)}
                </td>
                <td className="text-right py-3 px-4">
                  {data
                    .reduce((sum, emp) => sum + emp.overtimeHours, 0)
                    .toFixed(1)}
                </td>
                <td className="text-right py-3 px-4">
                  {data
                ...
                <td className="text-right py-3 px-4">
                  $
                  {data
                    .reduce((sum, emp) => sum + emp.regularPay, 0)
                    .toLocaleString()}
                </td>
                <td className="text-right py-3 px-4">
                  $
                  {data
                    .reduce((sum, emp) => sum + emp.overtimePay, 0)
                    .toLocaleString()}
                </td>
                <td className="text-right py-3 px-4">
                  $
                ...
                <td className="text-right py-3 px-4">
                  {data.reduce((sum, emp) => sum + emp.entries, 0)}
                </td>
              </tr>
            </tfoot>
          </table>
