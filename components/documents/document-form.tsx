...
export function DocumentForm({ projects, defaultProjectId, document }: DocumentFormProps) {
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Input id="title" name="title" defaultValue={document?.title} placeholder="Enter document title" required />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Select name="type" defaultValue={document?.type || "CONTRACT"} required>
              <SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Select name="projectId" defaultValue={document?.projectId || defaultProjectId || "NO_PROJECT"}>
              <SelectTrigger>
