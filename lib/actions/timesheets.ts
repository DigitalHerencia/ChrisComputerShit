...
export async function createTimesheet(_: unknown, formData: FormData) {
  ...
  const { projectId, userId: entryUserId, date, hoursWorked, overtime, description } = parsed.data
...
export async function updateTimesheet(_: unknown, formData: FormData) {
  ...
  const { id, projectId, userId: entryUserId, date, hoursWorked, overtime, description } = parsed.data
